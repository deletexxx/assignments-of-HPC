...
vector<vector<double>> strassen(vector<vector<double>> A, vector<vector<double>> B, int n){
    ...
    if(n==1){
        ...
        return C=GEMM(A,B,n,n,n);
    } //����һ����ֵ���ڵݹ鵽���ֵ�С����������ֵʱ���Ͳ���ʹ��strassen��ʹ��GEMM��������ʡʱ��
...
int main(){
    ...
    //computer
    st=clock();
    if(m==n && n==k && (n%2==0) ){//�������A��B���Ƿ��󣬲��Ҿ���߳���2�ı��������ܹ�ʹ��strassen�㷨
        cout<<"firstly, use strassen."<<endl;
        C=strassen(A,B,n);               //�ȵ���strassen�еݹ�ʱ�޷���һ�����󻮷�Ϊ�ĸ���ȵ�С���󣬾��ڴ�ʱ����GEMM
    }
    else{
        cout<<"firstly, use GEMM."<<endl;
        C=GEMM(A,B,m,n,k);
    }                 //�����һ�ξͲ���ʹ��strassen����ֱ��ʹ��GEMM
    fin=clock();
