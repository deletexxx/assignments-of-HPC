/* File:     4.cu
 *
 * Purpose:  Use im2col method combined with GEMM (General Matrix Multiplication) implemented in Task 1 to implement convolution operation.
 *
 * Compile:  nvcc -o 4 4.cu
 *
 * Run:      ./4 <N> <thread_block_size>
...
int main(int argc, char *argv[]){
    ...
    recover_answer(answer, map1, 3, output_size[0], output_size[0]);
